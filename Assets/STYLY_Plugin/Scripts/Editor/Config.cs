...
namespace STYLY.Uploader
{
	public class Config
	{
		public static string[] UNITY_VERSIONS = {"5.6", "2017.1", "2017.2"};
		public static string PLAYMAKER_VERSION = "1.8.4";
		...
		//禁止コンポーネント
		public static string[] ProhibitedComponents = new string[] {
			"AudioListener",
			"Camera",
			"RectTransform",
			"SpriteRenderer", // webで表示されない
		};

		public static string[] CanUseNameSpaces = new string[] {
			"UnityEngine",
