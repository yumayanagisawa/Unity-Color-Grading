...
namespace STYLY.Uploader
{
	...
	public class Editor : MonoBehaviour
	{
		...
		static void Startup()
		{
			...
			if (!(bool)isPlatformSupportLoaded.Invoke (null, new object[] { (string)getTargetStringFromBuildTarget.Invoke (null, new object[] { BuildTarget.StandaloneOSXIntel64 }) })) {
				requirementSatisfied = false;
			}
		...
		/// </summary>
		[MenuItem(@"Assets/STYLY/Upload prefab to STYLY", false, 10000)]
...
//			}
	...
	public class Settings : EditorWindow
	{
		...
		void OnGUI ()
		{
			...
			style.wordWrap = true;
			EditorGUILayout.LabelField ("Right click on a prefab and select \"STYLY\"-\"Upload prefab to STYLY\". Your prefab will appear in \"3D Model\"-\"My Models\" section in STYLY. ", style);
